...
export async function GET() {
  ...
  w.subTitle(`Generated by WillMyWay • ${generatedDateForDisplay}`);
  w.hr();
  ...
  w.spacer(6);
  w.drawText(
    "Note: This document is generated from information you provided in WillMyWay. If you are unsure about any clause or your circumstances are complex (e.g., minors, trusts, overseas assets), seek advice from a qualified South African legal professional.",
