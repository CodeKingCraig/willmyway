...
export default async function WillStep1Page() {
          ...
          <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_320px] xl:items-start">
            <div className="rounded-[30px] border border-white/70 bg-white/70 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.08)] backdrop-blur-xl sm:p-8">
              ...
              <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-600 sm:text-base">
                Let’s start with your basic personal information so your will
                clearly identifies who you are. This creates the foundation for
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  <div>
                    ...
                    <div className="mt-2 text-sm leading-6 text-slate-600">
                      Your name, identity details, date of birth, and address
                      help ensure your will is clear, valid, and unmistakably
                      yours.
                    </div>
                  </div>
            ...
            <aside className="xl:sticky xl:top-24">
              <div className="rounded-[30px] border border-white/70 bg-white/70 p-5 shadow-[0_20px_60px_rgba(15,23,42,0.08)] backdrop-blur-xl sm:p-6">
                ...
                <p className="mt-3 text-sm leading-7 text-slate-600">
                  We’ll take this one step at a time. Start with your personal
                  details, save your progress anytime, and move forward when
                  you’re ready.
                </p>

                <div className="mt-5 flex justify-center">
                  <video
                    src="/step-1-luma.webm"
                    autoPlay
                    muted
                    loop
                    playsInline
                ...
                <div className="mt-4 rounded-3xl bg-white/90 p-4 text-sm leading-6 text-slate-600 shadow-[0_12px_30px_rgba(15,23,42,0.08)] ring-1 ring-white/80">
                  <div className="text-sm font-semibold text-slate-900">
                    Step 1 checklist
                  </div>
                  <ul className="mt-2 space-y-1">
                    <li>• Full legal name</li>
                    <li>• ID number or passport</li>
                    <li>• Date of birth</li>
                    <li>• Main address details</li>
                  </ul>
                </div>
                ...
                <div className="mt-4 rounded-3xl bg-[#fffaf1] p-4 ring-1 ring-[#f4ead2]">
                  ...
                  <div className="mt-2 text-sm leading-6 text-slate-600">
                    You only need your full name and ID/passport to continue,
                    but adding the rest now will make the final document
                    stronger.
                  </div>
                </div>
              </div>
